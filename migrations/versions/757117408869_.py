...
Revision ID: 757117408869
Revises: 
Create Date: 2022-08-21 23:59:12.796442
...
def upgrade():
    ...
    sa.Column('recordDateTime', sa.String(length=20), nullable=True),
    ...
    sa.Column('OutsideTemp', sa.Float(), nullable=True),
    sa.Column('InsideTemp', sa.Float(), nullable=True),
    ...
    sa.Column('WaterTemp', sa.Float(), nullable=True),
